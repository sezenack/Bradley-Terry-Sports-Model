...
def main():
    ...
    wb = openpyxl.load_workbook('Bradley-Terry Spreadsheet NHL.xlsx')
    ...
    while g < firstsheet.max_row + 1:
        # Skip bad rows
        if firstsheet.cell(row = g, column = 1).value == 'Visitor':
            g += 1
            continue
        ...
        if regulation != '' and regulation is not None:
    ...
    wb.save('Bradley-Terry Spreadsheet NHL.xlsx')
    return ratings
